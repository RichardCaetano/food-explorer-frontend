...
O front-end do projeto, responsável pela interface do usuário, está disponível neste repositório. Já o back-end, que lida com a lógica e o armazenamento dos dados, está disponível [aqui](https://github.com/richardcaetano/food-explorer-backend).
...
A aplicação Food Explorer está disponível para uso [aqui](https://food-explorer-ri.netlify.app/).
...
```
$ git clone https://github.com/richardcaetano/food-explorer-frontend
```
...
- E-mail: admin@food-explorer.com
- Senha: 123456
...
- E-mail: client@food-explorer.com
- Senha: 123456
